...
import '../../../../styles/OPERATION/OPERATION_PAYROLLADMIN.scss';
...
class OperationPayrollAdmin extends Component {
  render() {
    return (
      <>
        <NavBar />
        ...
        <div className="asset-Operation-PayrollAdmin">
          <Row className="asset-Operation-PayrollAdmin-vacancy-title" justify="space-between">
          ...
          <Row className="asset-Operation-PayrollAdmin-wrapper" justify="space-between">
            <Col span={18} className="asset-Operation-PayrollAdmin-Box-left">
              <div className="assets-Operation-PayrollAdmin-info-top">
                <Row justify="space-between">
                  ...
                  <Col>
                    ...
                    <div className="assets-Operation-PayrollAdmin-info-socials">
            ...
            <Col span={5} className="asset-Operation-PayrollAdmin-Box-right">
              <div className="asset-hr-PayrollAdmin-Box-right-container">
                ...
                <div>
                  ...
                  <p>Opeartion Generalist, Operation Admin, Supervisor, Hiring Partner...</p>
                  <Link to='/assets/OPERATION-auditor'>Click <ArrowRightOutlined /></Link>
                </div>
              </div>

              <div className="asset-Operation-PayrollAdmin-Box-right-container">
                <div>
                  <img src={testImg} />
                </div>
                <div>
...
export default OperationPayrollAdmin;