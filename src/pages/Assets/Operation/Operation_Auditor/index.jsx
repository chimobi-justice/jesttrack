...
import '../../../../styles/OPERATION/OPERATION_AUDITOR.scss';
...
class OperationAuditor extends Component {
  render() {
    return (
      <>
        <NavBar />
        ...
        <div className="asset-Operation-auditor">
          <Row className="asset-Operation-auditor-vacancy-title" justify="space-between">
          ...
          <Row className="asset-Operation-auditor-wrapper" justify="space-between">
            <Col span={18} className="asset-Operation-auditor-Box-left">
              <div className="assets-Operation-auditor-info-top">
                <Row justify="space-between">
                  <Col>
                    <img src={testImg} alt="" />
                  </Col>
                  <Col>
                    <h3>Operation Auditor</h3>
                    <p>Operation Auditor Devision</p>
                    <div className="assets-Operation-auditor-info-socials">
            ...
            <Col span={5} className="asset-Operation-auditor-Box-right">
              <div className="asset-Operation-auditor-Box-right-container">
                <div>
                  <img src={testImg} />
                </div>
                <div>
...
export default OperationAuditor;