...
import '../../../../styles/OPERATION/OPERATION_SUPERVISOR.scss';
...
class OperationSupervisor extends Component {
  render() {
    return (
      <>
        <NavBar />
        ...
        <div className="asset-Operation-supervisor">
          <Row className="asset-Operation-supervisor-vacancy-title" justify="space-between">
          ...
          <Row className="asset-Operation-supervisor-wrapper" justify="space-between">
            <Col span={18} className="asset-Operation-supervisor-Box-left">
              <div className="assets-Operation-supervisor-info-top">
                <Row justify="space-between">
                  <Col>
                    <img src={testImg} alt="" />
                  </Col>
                  <Col>
                    <h3>Operation Supervisor</h3>
                    <p>Operation Supervisor Devision</p>
                    <div className="assets-Operation-supervisor-info-socials">
            ...
            <Col span={5} className="asset-Operation-supervisor-Box-right">
              <div className="asset-Operation-supervisor-Box-right-container">
                <div>
                  <img src={testImg} />
                </div>
                <div>
...
export default OperationSupervisor;