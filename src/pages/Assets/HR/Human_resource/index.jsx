...
class HRHumanResource extends Component {
  render() {
    return (
      <>
        <NavBar />
        ...
        <div className="asset-hr-HumanResource">
          ...
          <Row className="asset-hr-HumanResource-wrapper" justify="space-between">
            <Col span={18} className="asset-hr-HumanResource-Box-left">
              <div className="assets-hr-HumanResource-info-top">
            ...
            <Col span={5} className="asset-hr-HumanResource-Box-right">
              <div className="asset-hr-HumanResource-Box-right-container">
                <div>
                  <img src={testImg} />
                </div>
                <div>
              ...
              <div className="asset-hr-HumanResource-Box-right-container">
                ...
                <div>
                  <h4>Human Resources Department Head</h4>
                  <p>HR Generalist, HR Admin, Supervisor, Hiring Partner...</p>
...
export default HRHumanResource;