...
class HrAuditor extends Component {
  render() {
    return (
      <>
        <NavBar />
        ...
        <div className="asset-hr-auditor">
          ...
          <Row className="asset-hr-auditor-wrapper" justify="space-between">
            <Col span={18} className="asset-hr-auditor-Box-left">
              <div className="assets-hr-auditor-info-top">
                <Row justify="space-between">
                  ...
                  <Col>
                    <h3>HR Auditor</h3>
                    <p>HR Auditor Devision</p>
                    <div className="assets-hr-auditor-info-socials">
            ...
            <Col span={5} className="asset-hr-auditor-Box-right">
              <div className="asset-hr-auditor-Box-right-container">
                <div>
                  <img src={testImg} />
                </div>
                <div>
