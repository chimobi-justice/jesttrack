...
import '../../../../styles/HR/HR_RECRUITEMENTADMIN.scss';
...
class HrRecruitementAdmin extends Component {
  render() {
    return (
      <>
        <NavBar />
        ...
        <div className="asset-hr-RecruitementAdmin">
          <Row className="asset-hr-RecruitementAdmin-vacancy-title" justify="space-between">
          ...
          <Row className="asset-hr-RecruitementAdmin-wrapper" justify="space-between">
            <Col span={18} className="asset-hr-RecruitementAdmin-Box-left">
              <div className="assets-hr-RecruitementAdmin-info-top">
                <Row justify="space-between">
                  ...
                  <Col>
                    ...
                    <div className="assets-hr-RecruitementAdmin-info-socials">
            ...
            <Col span={5} className="asset-hr-RecruitementAdmin-Box-right">
              <div className="asset-hr-RecruitementAdmin-Box-right-container">
                <div>
                  <img src={testImg} />
                </div>
                <div>
...
export default HrRecruitementAdmin;