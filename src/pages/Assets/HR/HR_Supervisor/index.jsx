...
class HRSupervisor extends Component {
  render() {
    return (
      <>
        <NavBar />
        ...
        <div className="asset-hr-supervisor">
          ...
          <Row className="asset-hr-supervisor-wrapper" justify="space-between">
            <Col span={18} className="asset-hr-supervisor-Box-left">
              <div className="assets-hr-supervisor-info-top">
                <Row justify="space-between">
                  ...
                  <Col>
                    <h3>HR Supervisor</h3>
                    <p>HR Supervisor Devision</p>
                    <div className="assets-hr-supervisor-info-socials">
            ...
            <Col span={5} className="asset-hr-supervisor-Box-right">
              <div className="asset-hr-supervisor-Box-right-container">
                <div>
                  <img src={testImg} />
                </div>
                <div>
